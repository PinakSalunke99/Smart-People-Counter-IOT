...
while(cap.isOpened()):
                    ...
                    if abs(x-i.getX()) <= w and abs(y-i.getY()) <= h:
                        ...
                        if i.going_UP(line_down,line_up):
                            ...
                            if arduino.isOpen():                                
                                ...
                                total_cnt = cnt_down-cnt_up
                                update_display(total_cnt)
                        elif i.going_DOWNINDI(line_down,line_up):
                            cnt_down += 1
    ...
    str_up = 'Incoming: '+ str(cnt_up)
    str_down = 'Outgoing: '+ str(cnt_down)
    str_total = 'Total:'+str(cnt_down-cnt_up)
    ...
    cv.putText(frame, str_total ,(10,140),font,0.5,(255,255,255),2,cv.LINE_AA)
    cv.putText(frame, str_total ,(10,140),font,0.5,(0,0,255),1,cv.LINE_AA)
